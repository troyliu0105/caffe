...
if (USE_OPENMP)
    ...
    if (NOT MSVC)
        list(APPEND Caffe_LINKER_LIBS PUBLIC ${OpenMP_CXX_FLAGS})
    endif ()
    list(APPEND Caffe_COMPILE_OPTIONS PUBLIC ${OpenMP_CXX_FLAGS})
...
if (BUILD_python)
    ...
    if (PYTHONLIBS_FOUND AND NUMPY_FOUND AND (Boost_PYTHON_FOUND OR DEFINED CONAN_DEFINES_BOOST))
