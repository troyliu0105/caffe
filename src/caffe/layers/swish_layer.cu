...
void SwishLayer<Dtype>::Forward_gpu(const vector<Blob < Dtype> *
...
sigmoid_layer_->
Forward(sigmoid_bottom_vec_, sigmoid_top_vec_
);
caffe_gpu_mul(count, bottom_data, sigmoid_output_
->
...
template<typename Dtype>
void SwishLayer<Dtype>::Backward_gpu(const vector<Blob < Dtype> *
