...
#include "caffe/layers/loss/multibox_focal_loss_layer.hpp"
#include "caffe/util/math_functions.hpp"

namespace caffe {

template <typename Dtype>
void MultiBoxFocalLossLayer<Dtype>::LayerSetUp(
...
template <typename Dtype>
void MultiBoxFocalLossLayer<Dtype>::Forward_cpu(
    const vector<Blob<Dtype> *> &bottom, const vector<Blob<Dtype> *> &top) {
...
template <typename Dtype>
void MultiBoxFocalLossLayer<Dtype>::Backward_cpu(
