...
const string &expected_output_proto =
    ...
    "} ";
this->
RunPaddingUpgradeTest(input_proto, expected_output_proto
);
}
...
const string &expected_v1_proto =
    ...
    "} ";
this->
RunV0UpgradeTest(v0_proto, expected_v1_proto
);
...
const string &expected_v2_proto =
    ...
    "} ";
this->
RunV1UpgradeTest(expected_v1_proto, expected_v2_proto
);
}
...
const string &expected_output_proto =
    ...
    "} ";
this->
RunV0UpgradeTest(input_proto, expected_output_proto
);
}
...
for (
int i = 0;
i<V1LayerParameter_LayerType_LayerType_ARRAYSIZE;
++i) {
...
this->
RunSolverTypeUpgradeTest(input_proto, expected_output_proto
);
}
}
