...
image_data_param->set_source(this->filename_.
...
480);
EXPECT_EQ(this->blob_top_label_->
...
image_data_param->set_source(this->filename_reshape_.
...
values_to_indices[value] =
i;
num_in_order += (value ==
Dtype(i)
);
}
EXPECT_EQ(5, values_to_indices.
...
ImageDataParameter *image_data_param = param.mutable_image_data_param();
image_data_param->set_batch_size(1);
image_data_param->set_source(this->filename_space_.
