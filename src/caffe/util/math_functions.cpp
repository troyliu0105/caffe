...
template <>
void caffe_blas_gemm<double>(const CBLAS_TRANSPOSE TransA,
                             const CBLAS_TRANSPOSE TransB, const int M,
...
template <>
void caffe_blas_gemv<float>(const CBLAS_TRANSPOSE TransA, const int M,
...
template <>
void caffe_blas_gemv<double>(const CBLAS_TRANSPOSE TransA, const int M,
...
template <>
void caffe_blas_axpy<float>(const int N, const float alpha, const float *X,
                            float *Y) {
  cblas_saxpy(N, alpha, X, 1, Y, 1);
}

template <>
void caffe_blas_axpy<double>(const int N, const double alpha, const double *X,
                             double *Y) {
  cblas_daxpy(N, alpha, X, 1, Y, 1);
}

template <>
void caffe_blas_axpby<float>(const int N, const float alpha, const float *X,
                             const float beta, float *Y) {
  cblas_saxpby(N, alpha, X, 1, beta, Y, 1);
}

template <>
void caffe_blas_axpby<double>(const int N, const double alpha, const double *X,
...
template <>
void caffe_blas_scal<float>(const int N, const float alpha, float *X) {
  cblas_sscal(N, alpha, X, 1);
}

template <>
void caffe_blas_scal<double>(const int N, const double alpha, double *X) {
...
template <>
double caffe_blas_strided_dot<double>(const int n, const double *x,
...
template <>
float caffe_blas_asum<float>(const int n, const float *x) {
  return cblas_sasum(n, x, 1);
}

template <>
double caffe_blas_asum<double>(const int n, const double *x) {
  return cblas_dasum(n, x, 1);
}

template <>
void caffe_blas_scale<float>(const int n, const float alpha, const float *x,
                             float *y) {
...
template <>
void caffe_blas_scale<double>(const int n, const double alpha, const double *x,
                              double *y) {
